/**
 * Single source of truth for NeuroTrace workflow instructions.
 * Used by AGENTS.md, .cursor/rules/neurotrace.mdc, and .github/copilot-instructions.md.
 *
 * Extracted to its own module to avoid circular imports between
 * McpConfigManager and McpServerManager.
 */
export const NEUROTRACE_WORKFLOW_LINES: readonly string[] = [
